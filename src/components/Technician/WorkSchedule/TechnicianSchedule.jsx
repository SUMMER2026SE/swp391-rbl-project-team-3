...
export default function TechnicianSchedule({ technicianId }) {
    // We use the same storage key pattern as Doctor's schedule for caching confirmation state
    const storageKey = useMemo(
        () => `confirmed-shifts-${technicianId || 'default'}`,
        [technicianId]
    );
    ...
    useEffect(() => {
        const fetchSchedules = async () => {
            ...
            // Technicians share the same schedule table and structure as doctors
