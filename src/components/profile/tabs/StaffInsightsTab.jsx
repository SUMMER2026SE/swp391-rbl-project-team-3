        ...
        {metrics?.map?.((m, i) => {
          ...
          return (
            <motion.div
              ...
              className="glass-3d rounded-2xl p-5 flex flex-col gap-3 water-refract"
            >
...
function InfoTile({ icon: Icon, label, value, accent, full }) {
  return (
    <div className={`glass-inner rounded-xl px-4 py-3.5 flex items-center gap-3 ${full ? 'sm:col-span-2' : ''}`}>
