...
export const mockUserActivityLogs = [
    ...
    { id: "ACT-P07", timestamp: "2026-05-20T09:30:00Z", userId: "pat-01", userName: "Lê Minh Khôi",        role: "PATIENT", action: "PAYMENT",             details: "Thanh toán 300.000 VNĐ cho Khám Da Liễu Tổng Quát (apt-05) — Online VNPay",         module: "Thanh toán",        category: "payment" },
    { id: "ACT-P08", timestamp: "2026-05-15T10:30:00Z", userId: "pat-02", userName: "Trần Thị Hồng Nhung", role: "PATIENT", action: "PAYMENT",             details: "Thanh toán 1.800.000 VNĐ cho Điều Trị Nám Chuyên Sâu (apt-07) — Chuyển khoản",      module: "Thanh toán",        category: "payment" },
    { id: "ACT-P09", timestamp: "2026-05-10T15:00:00Z", userId: "pat-01", userName: "Lê Minh Khôi",        role: "PATIENT", action: "PAYMENT",             details: "Thanh toán 500.000 VNĐ cho Soi Da AI Chuyên Sâu (apt-06) — Tiền mặt",               module: "Thanh toán",        category: "payment" },
    { id: "ACT-P10", timestamp: "2026-05-08T10:30:00Z", userId: "pat-04", userName: "Nguyễn Hoàng Mai",    role: "PATIENT", action: "PAYMENT",             details: "Thanh toán 500.000 VNĐ cho Soi Da AI Chuyên Sâu (apt-04) — QR Code",                module: "Thanh toán",        category: "payment" },
    ...
    { id: "ACT-D02", timestamp: "2026-05-18T09:30:00Z", userId: "doc-01", userName: "BS. CKII. Trần Văn A",  role: "DOCTOR", action: "PRESCRIBE_MEDICINE",     details: "Kê đơn thuốc apt-08 cho Phạm Đức Anh — Calcipotriol ointment 0.005%, Tacrolimus 0.1%", module: "Đơn thuốc", category: "staff_prescription" },
    ...
    { id: "ACT-D04", timestamp: "2026-05-15T11:45:00Z", userId: "doc-02", userName: "ThS. BS. Nguyễn Thị B", role: "DOCTOR", action: "PRESCRIBE_MEDICINE",     details: "Kê đơn thuốc apt-07 cho Trần Thị Hồng Nhung — Tretinoin 0.05%, Arbutin Serum 2%, SPF50+ PA++++", module: "Đơn thuốc", category: "staff_prescription" },
    { id: "ACT-D05", timestamp: "2026-05-20T10:30:00Z", userId: "doc-01", userName: "BS. CKII. Trần Văn A",  role: "DOCTOR", action: "PRESCRIBE_MEDICINE",     details: "Kê đơn thuốc apt-05 cho Lê Minh Khôi — Hydrocortisone 1%, Cetirizine 10mg x 14 ngày", module: "Đơn thuốc",   category: "staff_prescription" },
    { id: "ACT-D06", timestamp: "2026-05-10T16:00:00Z", userId: "doc-01", userName: "BS. CKII. Trần Văn A",  role: "DOCTOR", action: "PRESCRIBE_MEDICINE",     details: "Kê đơn thuốc apt-06 cho Lê Minh Khôi — Serum Niacinamide 10%, SPF 50+ hàng ngày", module: "Đơn thuốc",       category: "staff_prescription" },
    { id: "ACT-D07", timestamp: "2026-06-06T14:00:00Z", userId: "doc-02", userName: "ThS. BS. Nguyễn Thị B", role: "DOCTOR", action: "CREATE_MEDICAL_RECORD",  details: "Tạo hồ sơ bệnh án mới cho Trần Thị Hồng Nhung — Nám hỗn hợp buổi 3/6",       module: "Hồ sơ bệnh án",     category: "staff_record" },
    { id: "ACT-D08", timestamp: "2026-06-05T09:30:00Z", userId: "doc-01", userName: "BS. CKII. Trần Văn A",  role: "DOCTOR", action: "UPDATE_MEDICAL_RECORD",  details: "Cập nhật hồ sơ Phạm Đức Anh — ghi nhận cải thiện 45% sau laser buổi 2",      module: "Hồ sơ bệnh án",     category: "staff_record" },
    { id: "ACT-D09", timestamp: "2026-06-04T11:00:00Z", userId: "doc-01", userName: "BS. CKII. Trần Văn A",  role: "DOCTOR", action: "START_EXAM",             details: "Bắt đầu ca khám apt-04 — Nguyễn Hoàng Mai, Soi Da AI",                        module: "Virtual Clinic",    category: "other" },
